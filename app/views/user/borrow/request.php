            ...
            <div class="card border-0 shadow-lg overflow-hidden rounded-4">
                <div class="row g-0">
                    <div class="col-md-4 bg-light p-4 text-center border-end">
                        <h5 class="text-success fw-bold mb-4">THÔNG TIN SÁCH</h5>
                        ...
                        <div class="badge bg-success-light text-success border border-success px-3 py-2 mt-2">
                            Có sẵn: <?= $book['available_copies'] ?> cuốn
                        </div>
                    </div>

                    <div class="col-md-8 p-5 bg-white">
                        <h3 class="fw-bold text-dark mb-4">Phiếu Đăng Ký Mượn Sách</h3>
                        <p class="text-muted mb-4">Vui lòng kiểm tra thông tin và chọn ngày trả dự kiến.</p>
                        ...
                        <form action="index.php?action=process_borrow" method="POST">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold text-uppercase text-muted">Người mượn</label>
                                    <input type="text" class="form-control bg-light" value="<?= $_SESSION['user_name'] ?? 'Thành viên' ?>" readonly>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold text-uppercase text-muted">Ngày mượn</label>
                                    <input type="text" class="form-control bg-light" value="<?= date('d/m/Y') ?>" readonly>
                                </div>

                                <div class="col-12 mt-4">
                                    <label for="due_date" class="form-label small fw-bold text-uppercase text-success">Ngày trả dự kiến *</label>
                                    ...
                                    <div class="form-text text-muted italic">Lưu ý: Thời gian mượn tối đa là 14 ngày.</div>
                                </div>

                                <div class="col-12 mt-3">
                                    <label for="notes" class="form-label small fw-bold text-uppercase text-muted">Ghi chú thêm</label>
                                    <textarea name="notes" id="notes" class="form-control" rows="3" placeholder="Ví dụ: Tôi sẽ bảo quản sách cẩn thận..."></textarea>
                                </div>

                                <div class="col-12 mt-4">
                                    <div class="alert alert-warning border-0 small py-2 px-3">
                                        <i class="fa fa-info-circle me-2"></i> Bằng việc nhấn "Xác nhận", bạn đồng ý với quy định trả sách đúng hạn của thư viện.
                                    </div>
                                </div>
